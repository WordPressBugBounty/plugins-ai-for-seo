...
if ($ai4seo_bulk_generation_queue_action !== AI4SEO_BULK_GENERATION_QUEUE_ACTION_SET_CUSTOM_INSTRUCTIONS) {
...
// Use the active context only for user-facing copy; persistence validates the context again on submit.
$ai4seo_generation_scope_label = ($ai4seo_context === AI4SEO_BULK_GENERATION_QUEUE_CONTEXT_ATTACHMENT_ATTRIBUTES)
...
echo "<div class='ai4seo-modal-content'>";
    echo "<div class='ai4seo-form ai4seo-bulk-custom-instructions-form'>";
        ...
        // Reuse the existing custom-instructions textarea and counter so subscription limits stay centralized.
