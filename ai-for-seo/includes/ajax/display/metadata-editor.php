...
echo "<div class='ai4seo-modal-headline'>";
    ...
    echo esc_html__("Metadata Editor", "ai-for-seo");
echo "</div>";
...
echo "<div class='ai4seo-form ai4seo-editor-form'>";
    ...
    echo "<div class='ai4seo-modal-footer ai4seo-buttons-wrapper'>";
        ...
        if ($ai4seo_next_post_id) {
            ai4seo_echo_wp_kses(ai4seo_get_button_tag(esc_html__("Save & edit next", "ai-for-seo"), "ai4seo-big-button ai4seo-lockable", "ai4seo_save_anything(jQuery(this), ai4seo_validate_metadata_editor_inputs, function() { ai4seo_open_metadata_editor_modal(" . esc_js($ai4seo_next_post_id) . ", " . esc_js($ai4seo_read_page_content_via_js) . ", " . esc_js(json_encode($ai4seo_all_post_ids)) . "); });"));
        }

        ai4seo_echo_wp_kses(ai4seo_get_submit_button_tag(esc_html__("Save changes", "ai-for-seo"), "ai4seo-big-button ai4seo-lockable ai4seo-start-inactive", "ai4seo_save_anything(jQuery(this), ai4seo_validate_metadata_editor_inputs, function() { ai4seo_safe_page_load(); });"));
    echo "</div>";
