...
$ai4seo_num_generated_posts_by_post_type = ai4seo_get_num_generated_posts_by_post_type();
$ai4seo_total_num_generated_posts = 0;

if (is_array($ai4seo_num_generated_posts_by_post_type) && $ai4seo_num_generated_posts_by_post_type) {
...
echo "<div class='ai4seo-modal-schema-content'>";
    if ($ai4seo_total_num_generated_posts > 0) {
        $ai4seo_total_num_generated_posts_formatted = number_format_i18n($ai4seo_total_num_generated_posts);
        $ai4seo_generated_entries_message = sprintf(
            _n(
                "AI for SEO has already generated SEO-relevant data for %s entry.",
                "AI for SEO has already generated SEO-relevant data for %s entries.",
        ...
        echo "<div class='ai4seo-generated-data-reminder-container'>";
            ...
            echo "<div id='ai4seo-remove-generated-data-action-container' class='ai4seo-remove-generated-data-action-container ai4seo-display-none'>";
                echo "<button type='button' id='ai4seo-autopilot-remove-generated-data-button' class='ai4seo-button ai4seo-lockable ai4seo-danger-button ai4seo-remove-generated-data-button' onclick='ai4seo_confirm_autopilot_remove_generated_data();'>";
                    ai4seo_echo_wp_kses(ai4seo_get_svg_tag("triangle-exclamation", "", "ai4seo-red-icon"));
                    echo " ";
                    echo esc_html__("Remove all AI-generated data", "ai-for-seo");
                echo "</button>";
            echo "</div>";
...
echo "<div class='ai4seo-modal-schema-footer'>";
    ...
    if ($ai4seo_is_any_bulk_generation_enabled) {
        ai4seo_echo_wp_kses(ai4seo_get_button_text_link_tag("#", "", esc_html__("Update SEO Autopilot", "ai-for-seo"), "ai4seo-success-button", "ai4seo_start_bulk_generation(this);"));
    } else {
        ai4seo_echo_wp_kses(ai4seo_get_button_text_link_tag("#", "", esc_html__("Start SEO Autopilot", "ai-for-seo"), "ai4seo-success-button", "ai4seo_start_bulk_generation(this);"));
    }
echo "</div>";