    ...
    echo "<div class='ai4seo-form ai4seo-small-form ai4seo-no-borders'>";
        ...
        echo "<div class='ai4seo-form-section'>";
            ...
            $ai4seo_this_setting_description = sprintf(
                /* translators: %s: Threshold of credits before refill triggers. */
            ...
            echo "<div class='ai4seo-form-item'>";
                ...
                echo "<div class='ai4seo-form-item-input-wrapper'>";
                    ...
                    foreach ($ai4seo_credits_packs AS $ai4seo_this_payg_stripe_price_id => $ai4seo_this_credits_pack_entry) {
                        ...
                        // Keep raw values for JavaScript calculations while sharing formatted values for modal summary updates.
                        $ai4seo_this_price_formatted = ai4seo_format_number_i18n($ai4seo_this_price, 2);
                        $ai4seo_this_discount_price_formatted = ai4seo_format_number_i18n($ai4seo_this_discount_price, 2);
                        $ai4seo_this_credits_amount_formatted = ai4seo_format_number_i18n($ai4seo_this_credits_amount, 0);

                        echo "<option value='" . esc_attr($ai4seo_this_payg_stripe_price_id) . "' "
                            . ($ai4seo_this_entry_is_pre_selected ? 'selected' : '')
                            . " data-price='" . esc_attr($ai4seo_this_discount_price)
                            . "' data-reference-price='" . esc_attr($ai4seo_this_price)
                            . "' data-price-formatted='" . esc_attr($ai4seo_this_discount_price_formatted)
                            . "' data-reference-price-formatted='" . esc_attr($ai4seo_this_price_formatted)
                            . "' data-credits-amount='" . esc_attr($ai4seo_this_credits_amount)
                            . "' data-credits-amount-formatted='" . esc_attr($ai4seo_this_credits_amount_formatted) . "'>";
                            echo esc_html($ai4seo_this_credits_amount_formatted) . ' Credits ('
                                . esc_html($ai4seo_used_currency_uppercase) . ' '
                                . esc_html($ai4seo_this_discount_price_formatted) . ')';
                        echo '</option>';
                    }
            ...
            echo '<ol>';
                echo '<li>';
                    echo sprintf(
                        ...
                        ($ai4seo_credits_pack_original_price != $ai4seo_credits_pack_discounted_price ? "<span style='text-decoration: line-through; color: #555;'>" . esc_html($ai4seo_used_currency_uppercase) . " <span id='ai4seo-payg-summary-reference-price'>" . esc_html(ai4seo_format_number_i18n($ai4seo_credits_pack_original_price, 2)) . '</span></span> ' : '') .
                ...
                echo '<li>';
                    ai4seo_echo_wp_kses(sprintf(
                        /* translators: %s: Daily spending limit. */
                        __('I will never spend more than %s within a <strong>24-hour period</strong>.', 'ai-for-seo'),
                        '<strong>' . esc_html($ai4seo_used_currency_uppercase) . " <span id='ai4seo-payg-summary-daily-budget'>" . esc_html(ai4seo_format_number_i18n($ai4seo_payg_daily_budget, 2)) . '</span></strong>',
                    ));
                    ai4seo_echo_wp_kses(ai4seo_get_icon_with_tooltip_tag(esc_html__('Including manually purchased Credits packs.', 'ai-for-seo')));
                echo '</li>';
                echo '<li>';
                    ai4seo_echo_wp_kses(sprintf(
                        /* translators: %s: Monthly spending limit. */
                        __('I will never spend more than %s per <strong>calendar month</strong>.', 'ai-for-seo'),
                        '<strong>' . esc_html($ai4seo_used_currency_uppercase) . " <span id='ai4seo-payg-summary-monthly-budget'>" . esc_html(ai4seo_format_number_i18n($ai4seo_payg_monthly_budget, 2)) . '</span></strong>',
                    ));
...
echo "<div class='ai4seo-modal-schema-footer'>";
    ...
    if ($ai4seo_is_payg_enabled) {
        ai4seo_echo_wp_kses(ai4seo_get_submit_button_tag(esc_html__('Submit', 'ai-for-seo'), 'ai4seo-start-inactive', 'ai4seo_handle_payg_submit(this);'));
        ...
        ai4seo_echo_wp_kses(ai4seo_get_submit_button_tag(esc_html__('Enable P-A-Y-G', 'ai-for-seo'), '', 'ai4seo_handle_payg_submit(this);'));
    }
