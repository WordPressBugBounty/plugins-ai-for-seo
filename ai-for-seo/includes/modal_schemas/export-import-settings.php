...
echo "<div class='ai4seo-modal-schema-content'>";
    ...
    echo "<div class='card ai4seo-form-section'>";
        ...
        // File
        echo "<div class='ai4seo-form-item'>";
            echo "<label for='ai4seo-import-file' style='margin-bottom: 10px; font-weight: bold;'>";
        ...
        echo "<div class='ai4seo-form-item'>";
            echo "<span class='ai4seo-form-item-label'>" . esc_html__('Select Categories to Import', 'ai-for-seo') . '</span>';
            echo "<div class='ai4seo-form-item-input-wrapper'>";
