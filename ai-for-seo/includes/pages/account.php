...
echo "<div class='ai4seo-form ai4seo-unsaved-changes-warnings'>";
    ...
    echo "<div class='card ai4seo-form-section'>";
        ...
        echo "<div class='ai4seo-form-item' style='padding-top:0;'>";
            echo "<div class='ai4seo-buttons-wrapper' style='margin-top: 1.5rem; margin-bottom: -.5rem;'>";
        ...
        echo "<div class='ai4seo-form-item'>";
            ...
            echo "<div class='ai4seo-form-item-input-wrapper'>";
                ...
                echo "<div style='max-width: 400px;'>";
                    // Keep consent text, tooltip, and toggle in one label so clicking the full row updates the same checkbox.
