...
$ai4seo_setting_plugin_description              = str_replace( '*' . AI4SEO_PLUGIN_NAME . '*', AI4SEO_PLUGIN_NAME, ai4seo_get_setting( AI4SEO_SETTING_INSTALLED_PLUGINS_PLUGIN_DESCRIPTION ) );
