...
// Keep external support separate from the cards that switch the current Help section.
echo "<section class='ai4seo-help-support' aria-labelledby='ai4seo-help-support-heading'>";
echo "<div class='ai4seo-help-support-copy'>";
echo "<h2 id='ai4seo-help-support-heading'>" . esc_html__( 'Contact support', 'ai-for-seo' ) . '</h2>';
echo '<p>' . esc_html__( 'Choose how to contact us on sooz.ai. Messages in any language are welcome.', 'ai-for-seo' ) . '</p>';
echo '</div>';
ai4seo_echo_wp_kses(
	ai4seo_get_a_tag_icon_button_tag(
		AI4SEO_OFFICIAL_CONTACT_URL,
		'ai4seo-help-support-link',
		'_blank',
		'arrow-up-right-from-square',
		__( 'Open contact page (opens in a new tab)', 'ai-for-seo' ),
		'ai4seo-secondary-button'
	)
);
echo '</section>';
...
foreach ( $ai4seo_credits_packs as $ai4seo_this_payg_stripe_price_id => $ai4seo_credits_pack_entry ) {
	...
	echo "<div class='ai4seo-faq-section-holder'>";
		...
		ai4seo_echo_wp_kses( ai4seo_get_accordion_element( esc_html__( 'Why should I add SEO titles, meta descriptions, and metadata to my website?', 'ai-for-seo' ), $ai4seo_this_accordion_content, 4 ) );
		...
		ai4seo_echo_wp_kses( ai4seo_get_accordion_element( esc_html__( 'How do I switch between Preview and Editor mode in the Metadata or Media Attributes editor?', 'ai-for-seo' ), $ai4seo_this_accordion_content, 4 ) );
		...
		ai4seo_echo_wp_kses( ai4seo_get_accordion_element( esc_html__( 'Is AI-generated SEO content safe for Google rankings?', 'ai-for-seo' ), $ai4seo_this_accordion_content, 4 ) );
		...
		/* translators: %s: plugin name */
		ai4seo_echo_wp_kses( ai4seo_get_accordion_element( sprintf( esc_html__( 'Does %s analyze my page, post, product, or media content before generating SEO data?', 'ai-for-seo' ), esc_html( AI4SEO_PLUGIN_NAME ) ), $ai4seo_this_accordion_content, 4 ) );
		...
		ai4seo_echo_wp_kses( ai4seo_get_accordion_element( esc_html__( 'Where do I open a page, post, or product to edit its SEO metadata?', 'ai-for-seo' ), $ai4seo_this_accordion_content, 4 ) );
		...
		/* translators: %s: plugin name */
		ai4seo_echo_wp_kses( ai4seo_get_accordion_element( sprintf( esc_html__( 'Where do I find the %s metadata editor in WordPress?', 'ai-for-seo' ), esc_html( AI4SEO_PLUGIN_NAME ) ), $ai4seo_this_accordion_content, 4 ) );
		...
		ai4seo_echo_wp_kses( ai4seo_get_accordion_element( esc_html__( 'How do I generate or manually edit SEO titles, descriptions, and other metadata?', 'ai-for-seo' ), $ai4seo_this_accordion_content, 4 ) );
		...
		/* translators: %s: plugin name */
		ai4seo_echo_wp_kses( ai4seo_get_accordion_element( sprintf( esc_html__( 'Can I edit SEO metadata from the %s Pages, Posts, or Products lists?', 'ai-for-seo' ), esc_html( AI4SEO_PLUGIN_NAME ) ), $ai4seo_this_accordion_content, 4 ) );
		...
		ai4seo_echo_wp_kses( ai4seo_get_accordion_element( esc_html__( 'Which WordPress editors and page builders are supported?', 'ai-for-seo' ), $ai4seo_this_accordion_content, 4 ) );
		...
		/* translators: %s: plugin name */
		ai4seo_echo_wp_kses( ai4seo_get_accordion_element( sprintf( esc_html__( 'How do I edit or generate SEO metadata in Elementor with %s?', 'ai-for-seo' ), esc_html( AI4SEO_PLUGIN_NAME ) ), $ai4seo_this_accordion_content, 4 ) );
		...
		/* translators: %s: plugin name */
		ai4seo_echo_wp_kses( ai4seo_get_accordion_element( sprintf( esc_html__( 'How do I edit or generate SEO metadata in BeBuilder or BeTheme with %s?', 'ai-for-seo' ), esc_html( AI4SEO_PLUGIN_NAME ) ), $ai4seo_this_accordion_content, 4 ) );
		...
		ai4seo_echo_wp_kses( ai4seo_get_accordion_element( esc_html__( 'Can you add support for another editor, page builder, or SEO feature?', 'ai-for-seo' ), $ai4seo_this_accordion_content, 4 ) );
		...
		ai4seo_echo_wp_kses( ai4seo_get_accordion_element( esc_html__( 'Which placeholders can I use in metadata, media prefixes, or suffixes?', 'ai-for-seo' ), $ai4seo_this_accordion_content, 4 ) );
		...
		ai4seo_echo_wp_kses( ai4seo_get_accordion_element( esc_html__( 'How do I include WooCommerce product prices in SEO titles and descriptions?', 'ai-for-seo' ), $ai4seo_this_accordion_content, 4 ) );
		...
		ai4seo_echo_wp_kses( ai4seo_get_accordion_element( esc_html__( 'How do I make generated SEO titles and meta descriptions match my brand voice?', 'ai-for-seo' ), $ai4seo_this_accordion_content, 4 ) );
		...
		ai4seo_echo_wp_kses( ai4seo_get_accordion_element( esc_html__( 'Where should I add Custom Instructions: global, metadata, media, post type, or entry?', 'ai-for-seo' ), $ai4seo_this_accordion_content, 4 ) );
		...
		/* translators: %s: plugin name */
		ai4seo_echo_wp_kses( ai4seo_get_accordion_element( sprintf( esc_html__( 'Why does %s warn me about a missing focus keyphrase?', 'ai-for-seo' ), esc_html( AI4SEO_PLUGIN_NAME ) ), $ai4seo_this_accordion_content, 4 ) );
		...
		ai4seo_echo_wp_kses( ai4seo_get_accordion_element( esc_html__( 'How can I tell whether a title, meta description, or alt text was generated, imported, or edited?', 'ai-for-seo' ), $ai4seo_this_accordion_content, 4 ) );
		...
		ai4seo_echo_wp_kses( ai4seo_get_accordion_element( esc_html__( 'Why are some meta tags or media attribute fields missing from the editor?', 'ai-for-seo' ), $ai4seo_this_accordion_content, 4 ) );
		...
		/* translators: %s: plugin name */
		ai4seo_echo_wp_kses( ai4seo_get_accordion_element( sprintf( esc_html__( 'How do I control which meta tags %s outputs on the frontend?', 'ai-for-seo' ), esc_html( AI4SEO_PLUGIN_NAME ) ), $ai4seo_this_accordion_content, 4 ) );
		...
		ai4seo_echo_wp_kses( ai4seo_get_accordion_element( esc_html__( 'Why should I add alt text, image titles, captions, and descriptions?', 'ai-for-seo' ), $ai4seo_this_accordion_content, 4 ) );
		...
		ai4seo_echo_wp_kses( ai4seo_get_accordion_element( esc_html__( 'Why is alt text or image attribute generation more accurate for some images?', 'ai-for-seo' ), $ai4seo_this_accordion_content, 4 ) );
		...
		ai4seo_echo_wp_kses( ai4seo_get_accordion_element( esc_html__( 'How do I fix image attributes that sound generic, repetitive, or keyword-stuffed?', 'ai-for-seo' ), $ai4seo_this_accordion_content, 4 ) );
		...
		/* translators: %s: plugin name */
		ai4seo_echo_wp_kses( ai4seo_get_accordion_element( sprintf( esc_html__( 'What happens if %s cannot access an image URL from my CDN, firewall, or host?', 'ai-for-seo' ), esc_html( AI4SEO_PLUGIN_NAME ) ), $ai4seo_this_accordion_content, 4 ) );
		...
		ai4seo_echo_wp_kses( ai4seo_get_accordion_element( esc_html__( 'Why is alt text missing on my frontend images even though it is saved?', 'ai-for-seo' ), $ai4seo_this_accordion_content, 4 ) );
		...
		ai4seo_echo_wp_kses( ai4seo_get_accordion_element( esc_html__( 'What is Alt Text Injection and when should I use it?', 'ai-for-seo' ), $ai4seo_this_accordion_content, 4 ) );
		...
		/* translators: %s: plugin name */
		ai4seo_echo_wp_kses( ai4seo_get_accordion_element( sprintf( esc_html__( 'Can I choose which image attributes %s generates, such as alt text, title, caption, or description?', 'ai-for-seo' ), esc_html( AI4SEO_PLUGIN_NAME ) ), $ai4seo_this_accordion_content, 4 ) );
		...
		/* translators: %s: plugin name */
		ai4seo_echo_wp_kses( ai4seo_get_accordion_element( sprintf( esc_html__( 'How do I find related images %s detected for a page, post, or product?', 'ai-for-seo' ), esc_html( AI4SEO_PLUGIN_NAME ) ), $ai4seo_this_accordion_content, 4 ) );
		...
		ai4seo_echo_wp_kses( ai4seo_get_accordion_element( esc_html__( 'Can I bulk-generate alt text and image attributes for all related images?', 'ai-for-seo' ), $ai4seo_this_accordion_content, 4 ) );
		...
		ai4seo_echo_wp_kses( ai4seo_get_accordion_element( esc_html__( 'How do I generate alt text and media attributes for NextGen Gallery images?', 'ai-for-seo' ), $ai4seo_this_accordion_content, 4 ) );
		...
		ai4seo_echo_wp_kses( ai4seo_get_accordion_element( esc_html__( 'How do I use SEO Autopilot to bulk-generate metadata?', 'ai-for-seo' ), $ai4seo_this_accordion_content, 4 ) );
		...
		ai4seo_echo_wp_kses( ai4seo_get_accordion_element( esc_html__( 'How do I use SEO Autopilot to bulk-generate alt text and media attributes?', 'ai-for-seo' ), $ai4seo_this_accordion_content, 4 ) );
		...
		ai4seo_echo_wp_kses( ai4seo_get_accordion_element( esc_html__( 'How do I turn off or stop the SEO Autopilot for specific content types?', 'ai-for-seo' ), $ai4seo_this_accordion_content, 4 ) );
		...
		ai4seo_echo_wp_kses( ai4seo_get_accordion_element( esc_html__( 'How do I stop SEO Autopilot from automatically adding entries to the queue?', 'ai-for-seo' ), $ai4seo_this_accordion_content, 4 ) );
		...
		ai4seo_echo_wp_kses( ai4seo_get_accordion_element( esc_html__( 'Can SEO Autopilot generate metadata for new content only, existing content only, or both?', 'ai-for-seo' ), $ai4seo_this_accordion_content, 4 ) );
		...
		ai4seo_echo_wp_kses( ai4seo_get_accordion_element( esc_html__( 'Will SEO Autopilot overwrite existing SEO titles, descriptions, or media attributes?', 'ai-for-seo' ), $ai4seo_this_accordion_content, 4 ) );
		...
		ai4seo_echo_wp_kses( ai4seo_get_accordion_element( esc_html__( 'What is the difference between Add to queue (safe) and Add to queue (force)?', 'ai-for-seo' ), $ai4seo_this_accordion_content, 4 ) );
		...
		ai4seo_echo_wp_kses( ai4seo_get_accordion_element( esc_html__( 'What do Hidden, Waiting, Queued, Processing, and Failed queue statuses mean?', 'ai-for-seo' ), $ai4seo_this_accordion_content, 4 ) );
		...
		/* translators: %s: plugin name */
		ai4seo_echo_wp_kses( ai4seo_get_accordion_element( sprintf( esc_html__( 'Can I use %s bulk actions in normal WordPress Posts, Pages, Products, and Media Library screens?', 'ai-for-seo' ), esc_html( AI4SEO_PLUGIN_NAME ) ), $ai4seo_this_accordion_content, 4 ) );
		...
		/* translators: %s: plugin name */
		ai4seo_echo_wp_kses( ai4seo_get_accordion_element( sprintf( esc_html__( 'How do I hide entries from %s lists without deleting SEO data?', 'ai-for-seo' ), esc_html( AI4SEO_PLUGIN_NAME ) ), $ai4seo_this_accordion_content, 4 ) );
		...
		ai4seo_echo_wp_kses( ai4seo_get_accordion_element( esc_html__( 'When should I exclude an entry from Auto Queue instead of hiding it?', 'ai-for-seo' ), $ai4seo_this_accordion_content, 4 ) );
		...
		ai4seo_echo_wp_kses( ai4seo_get_accordion_element( esc_html__( 'If metadata was generated with the wrong settings, should I mark the affected entries as not generated, or delete the plugin metadata using the bulk actions?', 'ai-for-seo' ), $ai4seo_this_accordion_content, 4 ) );
		...
		ai4seo_echo_wp_kses( ai4seo_get_accordion_element( esc_html__( 'How do I retry failed metadata or media attribute generations?', 'ai-for-seo' ), $ai4seo_this_accordion_content, 4 ) );
		...
		ai4seo_echo_wp_kses( ai4seo_get_accordion_element( esc_html__( 'Why is automatic metadata or media attribute generation pending?', 'ai-for-seo' ), $ai4seo_this_accordion_content, 4 ) );
		...
		ai4seo_echo_wp_kses( ai4seo_get_accordion_element( esc_html__( 'Why did SEO Autopilot skip complete entries or mark them already completed?', 'ai-for-seo' ), $ai4seo_this_accordion_content, 4 ) );
		...
		/* translators: %s: plugin name */
		ai4seo_echo_wp_kses( ai4seo_get_accordion_element( sprintf( esc_html__( 'Can I use %s with Yoast SEO, Rank Math, or another SEO plugin?', 'ai-for-seo' ), esc_html( AI4SEO_PLUGIN_NAME ) ), $ai4seo_this_accordion_content, 4 ) );
		...
		/* translators: %s: plugin name */
		ai4seo_echo_wp_kses( ai4seo_get_accordion_element( sprintf( esc_html__( 'How do I sync %s metadata with Yoast SEO, Rank Math, or another SEO plugin?', 'ai-for-seo' ), esc_html( AI4SEO_PLUGIN_NAME ) ), $ai4seo_this_accordion_content, 4 ) );
		...
		ai4seo_echo_wp_kses( ai4seo_get_accordion_element( esc_html__( 'Why are changes in Yoast, Rank Math, or another SEO plugin not showing on the frontend?', 'ai-for-seo' ), $ai4seo_this_accordion_content, 4 ) );
		...
		/* translators: %s: plugin name */
		ai4seo_echo_wp_kses( ai4seo_get_accordion_element( sprintf( esc_html__( 'How do I hide post types from the %s dashboard and SEO Autopilot?', 'ai-for-seo' ), esc_html( AI4SEO_PLUGIN_NAME ) ), $ai4seo_this_accordion_content, 4 ) );
		...
		ai4seo_echo_wp_kses( ai4seo_get_accordion_element( esc_html__( 'Can I include or exclude pages, posts, products, or media by author?', 'ai-for-seo' ), $ai4seo_this_accordion_content, 4 ) );
		...
		ai4seo_echo_wp_kses( ai4seo_get_accordion_element( esc_html__( 'Can I include or exclude posts, products, or other content by category or taxonomy term?', 'ai-for-seo' ), $ai4seo_this_accordion_content, 4 ) );
		...
		/* translators: %s: plugin name */
		ai4seo_echo_wp_kses( ai4seo_get_accordion_element( sprintf( esc_html__( 'Does %s support WPML and multilingual websites?', 'ai-for-seo' ), esc_html( AI4SEO_PLUGIN_NAME ) ), $ai4seo_this_accordion_content, 4 ) );
		...
		/* translators: %s: plugin name */
		ai4seo_echo_wp_kses( ai4seo_get_accordion_element( sprintf( esc_html__( 'Can I exclude one WPML language from SEO Autopilot or %s lists?', 'ai-for-seo' ), esc_html( AI4SEO_PLUGIN_NAME ) ), $ai4seo_this_accordion_content, 4 ) );
		...
		ai4seo_echo_wp_kses( ai4seo_get_accordion_element( esc_html__( 'Do free plan Credits renew every day?', 'ai-for-seo' ), $ai4seo_this_accordion_content, 4 ) );
		...
		ai4seo_echo_wp_kses( ai4seo_get_accordion_element( esc_html__( 'How do I receive the free daily Credits?', 'ai-for-seo' ), $ai4seo_this_accordion_content, 4 ) );
		...
		ai4seo_echo_wp_kses( ai4seo_get_accordion_element( esc_html__( 'Do paid plans still receive free daily Credits?', 'ai-for-seo' ), $ai4seo_this_accordion_content, 4 ) );
		...
		/* translators: %s: plugin name */
		ai4seo_echo_wp_kses( ai4seo_get_accordion_element( sprintf( esc_html__( 'How are Credits used for metadata, meta tags, alt text, and media attributes in %s?', 'ai-for-seo' ), esc_html( AI4SEO_PLUGIN_NAME ) ), $ai4seo_this_accordion_content, 4 ) );
		...
		/* translators: %s: plugin name */
		ai4seo_echo_wp_kses( ai4seo_get_accordion_element( sprintf( esc_html__( 'Can I try %s without buying a subscription?', 'ai-for-seo' ), esc_html( AI4SEO_PLUGIN_NAME ) ), $ai4seo_this_accordion_content, 4 ) );
		...
		ai4seo_echo_wp_kses( ai4seo_get_accordion_element( esc_html__( 'How many Credits do Basic, Pro, and Premium subscriptions include?', 'ai-for-seo' ), $ai4seo_this_accordion_content, 4 ) );
		...
		ai4seo_echo_wp_kses( ai4seo_get_accordion_element( esc_html__( 'Which subscription plan should I choose for my website?', 'ai-for-seo' ), $ai4seo_this_accordion_content, 4 ) );
		...
		/* translators: %s: plugin name */
		ai4seo_echo_wp_kses( ai4seo_get_accordion_element( sprintf( esc_html__( 'Does deactivating or uninstalling %s cancel my subscription or Pay-As-You-Go refills?', 'ai-for-seo' ), esc_html( AI4SEO_PLUGIN_NAME ) ), $ai4seo_this_accordion_content, 4 ) );
		...
		/* translators: %s: plugin name */
		ai4seo_echo_wp_kses( ai4seo_get_accordion_element( sprintf( esc_html__( 'How do I change or cancel my %s subscription?', 'ai-for-seo' ), esc_html( AI4SEO_PLUGIN_NAME ) ), $ai4seo_this_accordion_content, 4 ) );
		...
		ai4seo_echo_wp_kses( ai4seo_get_accordion_element( esc_html__( 'Can I upgrade or downgrade my subscription plan?', 'ai-for-seo' ), $ai4seo_this_accordion_content, 4 ) );
		...
		ai4seo_echo_wp_kses( ai4seo_get_accordion_element( esc_html__( 'Do unused Credits expire or roll over at the end of the month?', 'ai-for-seo' ), $ai4seo_this_accordion_content, 4 ) );
		...
		ai4seo_echo_wp_kses( ai4seo_get_accordion_element( esc_html__( 'Can I use my subscription, Credits Packs, or license key on another website?', 'ai-for-seo' ), $ai4seo_this_accordion_content, 4 ) );
		...
		/* translators: %s: plugin name */
		ai4seo_echo_wp_kses( ai4seo_get_accordion_element( sprintf( esc_html__( 'How do I export, import, or reuse %s settings on another website?', 'ai-for-seo' ), esc_html( AI4SEO_PLUGIN_NAME ) ), $ai4seo_this_accordion_content, 4 ) );
		...
		/* translators: %s: plugin name */
		ai4seo_echo_wp_kses( ai4seo_get_accordion_element( sprintf( esc_html__( 'How do I reset %s settings to default values?', 'ai-for-seo' ), esc_html( AI4SEO_PLUGIN_NAME ) ), $ai4seo_this_accordion_content, 4 ) );
		...
		/* translators: %s: plugin name */
		ai4seo_echo_wp_kses( ai4seo_get_accordion_element( sprintf( esc_html__( 'How do I uninstall %s and remove generated metadata or plugin data?', 'ai-for-seo' ), esc_html( AI4SEO_PLUGIN_NAME ) ), $ai4seo_this_accordion_content, 4 ) );
		...
		/* translators: %s: plugin name */
		ai4seo_echo_wp_kses( ai4seo_get_accordion_element( sprintf( esc_html__( 'Will generated metadata or image attributes disappear if I uninstall %s?', 'ai-for-seo' ), esc_html( AI4SEO_PLUGIN_NAME ) ), $ai4seo_this_accordion_content, 4 ) );
		...
		ai4seo_echo_wp_kses( ai4seo_get_accordion_element( esc_html__( 'I generated metadata or image attributes with the wrong settings. How do I fix it?', 'ai-for-seo' ), $ai4seo_this_accordion_content, 4 ) );
		...
		ai4seo_echo_wp_kses( ai4seo_get_accordion_element( esc_html__( 'What cron job setup is recommended for SEO Autopilot and scheduled tasks?', 'ai-for-seo' ), $ai4seo_this_accordion_content, 4 ) );
		...
		ai4seo_echo_wp_kses( ai4seo_get_accordion_element( esc_html__( 'I use WordPress WP-Cron. What should I consider for SEO Autopilot?', 'ai-for-seo' ), $ai4seo_this_accordion_content, 4 ) );
		...
		ai4seo_echo_wp_kses( ai4seo_get_accordion_element( esc_html__( 'My external cron job runs every 2 minutes or less often. What should I change?', 'ai-for-seo' ), $ai4seo_this_accordion_content, 4 ) );
		...
		ai4seo_echo_wp_kses( ai4seo_get_accordion_element( esc_html__( 'The analysis of pages or media files is slowing down my site. How can I pause it?', 'ai-for-seo' ), $ai4seo_this_accordion_content, 4 ) );
		...
		ai4seo_echo_wp_kses( ai4seo_get_accordion_element( esc_html__( 'Generated metadata is not visible on the frontend or Google snippet. What can I do?', 'ai-for-seo' ), $ai4seo_this_accordion_content, 4 ) );
		...
		if ( $ai4seo_can_administer_plugin ) {
			...
			/* translators: %s: plugin name */
			ai4seo_echo_wp_kses( ai4seo_get_accordion_element( sprintf( esc_html__( 'How do I debug unexpected plugin behavior or find the %s debug log?', 'ai-for-seo' ), esc_html( AI4SEO_PLUGIN_NAME ) ), $ai4seo_this_accordion_content, 4 ) );
			...
			ai4seo_echo_wp_kses( ai4seo_get_accordion_element( esc_html__( 'WP-Cron is not running reliably. How do I switch to an external WordPress cron job?', 'ai-for-seo' ), $ai4seo_this_accordion_content, 4 ) );
			...
			if ( ! empty( $ai4seo_debug_message_entries ) ) {
				...
				echo '</button>';
					...
					// Keep the existing resource destinations together with their card presentation.
					$ai4seo_help_resources = array(
						array(
							'url'         => AI4SEO_OFFICIAL_WEBSITE,
							'icon'        => 'dashicons-admin-site-alt3',
							'title'       => __( 'Official plugin website', 'ai-for-seo' ),
							'description' => __( 'Explore SOOZ and learn more about the plugin.', 'ai-for-seo' ),
							'action'      => __( 'Visit website', 'ai-for-seo' ),
						),
						array(
							'url'         => AI4SEO_PLUGINS_OFFICIAL_WORDPRESS_ORG_PAGE,
							'icon'        => 'dashicons-wordpress',
							'title'       => __( 'WordPress plugin page', 'ai-for-seo' ),
							'description' => __( 'Find the plugin listing on WordPress.org.', 'ai-for-seo' ),
							'action'      => __( 'View plugin', 'ai-for-seo' ),
						),
						array(
							'url'         => 'https://wordpress.org/support/plugin/ai-for-seo/',
							'icon'        => 'dashicons-format-chat',
							'title'       => __( 'Support forum', 'ai-for-seo' ),
							'description' => __( 'Browse discussions or ask for help on WordPress.org.', 'ai-for-seo' ),
							'action'      => __( 'Visit support forum', 'ai-for-seo' ),
						),
						array(
							'url'         => 'https://spa.ce.codes',
							'icon'        => 'dashicons-groups',
							'title'       => __( 'Meet the makers', 'ai-for-seo' ),
							/* translators: %s: plugin name */
							'description' => sprintf( __( 'Get to know Space Codes, the team behind %s.', 'ai-for-seo' ), AI4SEO_PLUGIN_NAME ),
							'action'      => __( 'Meet Space Codes', 'ai-for-seo' ),
						),
					);

					echo "<div class='ai4seo-help-resources'>";
