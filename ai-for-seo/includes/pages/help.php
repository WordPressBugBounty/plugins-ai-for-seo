...
echo "<div class='ai4seo-display-none ai4seo-help-content' id='ai4seo-help-getting-started'>";
    ...
    $ai4seo_this_accordion_content = "<p>" . __("Credits are used when *AI for SEO* generates metadata for your content (posts, pages, products, media files etc.). The amount of Credits required depends on the selected active meta tags and media attributes (see Settings).", "ai-for-seo") . "</p>";
...
echo "<div class='ai4seo-display-none ai4seo-help-content' id='ai4seo-help-faq'>";
    ...
    echo "<div class='ai4seo-faq-section-holder'>";
        ...
        ai4seo_echo_wp_kses(ai4seo_get_accordion_element("> " . esc_html__("Can I use *AI for SEO* alongside another SEO plugin?", "ai-for-seo"), $ai4seo_this_accordion_content));
        ...
        ai4seo_echo_wp_kses(ai4seo_get_accordion_element("> " . esc_html__("Does *AI for SEO* support multi-language websites?", "ai-for-seo"), $ai4seo_this_accordion_content));
        ...
        $ai4seo_this_accordion_content  = __( 'Yes, you can use *AI for SEO* on staging or local development sites.', 'ai-for-seo' );
        ai4seo_echo_wp_kses(
            ai4seo_get_accordion_element(
    ...
    echo "<div class='ai4seo-faq-section-holder'>";
        ...
        ai4seo_echo_wp_kses(ai4seo_get_accordion_element("> " . esc_html__("Where is the *AI for SEO* metadata editor located?", "ai-for-seo"), $ai4seo_this_accordion_content));
        ...
        ai4seo_echo_wp_kses(ai4seo_get_accordion_element("> " . esc_html__("Is there an alternate way to access *AI for SEO*'s Metadata Editor?", "ai-for-seo"), $ai4seo_this_accordion_content));
        ...
        ai4seo_echo_wp_kses(ai4seo_get_accordion_element("> " . esc_html__("How do I edit metadata in Elementor with *AI for SEO*?", "ai-for-seo"), $ai4seo_this_accordion_content));
        ...
        ai4seo_echo_wp_kses(ai4seo_get_accordion_element("> " . esc_html__("How do I edit SEO settings in BeBuilder with *AI for SEO*?", "ai-for-seo"), $ai4seo_this_accordion_content));
    ...
    echo "<div class='ai4seo-faq-section-holder'>";
        ...
        $ai4seo_this_accordion_content = __("Credits are used when *AI for SEO* generates metadata for your content (posts, pages, products, media files etc.). The amount of Credits required depends on the selected active meta tags and media attributes (see Settings).", "ai-for-seo") . "<br /><br />";
        ai4seo_echo_wp_kses(ai4seo_get_accordion_element("> " . esc_html__("How are Credits consumed in the *AI for SEO* plugin?", "ai-for-seo"), $ai4seo_this_accordion_content));

        $ai4seo_this_accordion_content = sprintf(
            __("Yes, the free plan provides you with %u Credits, allowing you to experiment with AI-generated SEO content without any cost. In addition, we provide you with %u free Credits every day if your balance falls below %s Credits. However it does not include advanced features available in paid subscriptions.", "ai-for-seo"),
            esc_html($ai4seo_free_plan_credits),
            esc_html(AI4SEO_DAILY_FREE_CREDITS_AMOUNT),
            esc_html($ai4seo_free_plan_credits),
        );
        ai4seo_echo_wp_kses(ai4seo_get_accordion_element("> " . esc_html__("Can I try the *AI for SEO* plugin without purchasing a subscription?", "ai-for-seo"), $ai4seo_this_accordion_content));

        $ai4seo_this_accordion_content = sprintf(
            "- " . __("The Basic subscription grants you %u Credits per month, suitable for smaller websites or blogs. It covers approximately %u focus keyphrases, meta tags, or image attributes per month, depending on your selected settings. Existing data can be used as reference for new data generations.", "ai-for-seo") . "<br />",
            esc_html($ai4seo_s_plan_credits),
            esc_html($ai4seo_s_plan_credits),
        );
        $ai4seo_this_accordion_content .= sprintf(
            "- " . __("The Pro subscription grants you %u Credits per month, designed for professionals who need more extensive SEO capabilities. It covers approximately %u focus keyphrases, meta tags, or image attributes per month, depending on your selected settings. It also features improved entity recognition in images.", "ai-for-seo") . "<br />",
            esc_html($ai4seo_m_plan_credits),
            esc_html($ai4seo_m_plan_credits),
        );
        $ai4seo_this_accordion_content .= sprintf(
            "- " . __("The Premium subscription grants you %u Credits per month, ideal for businesses that require substantial SEO support and features. It covers approximately %u focus keyphrases, meta tags, or image attributes per month, depending on your selected settings. It also features improved entity and celebrity face recognition in images.", "ai-for-seo"),
            esc_html($ai4seo_l_plan_credits),
            esc_html($ai4seo_l_plan_credits),
        );
        ...
        $ai4seo_this_accordion_content = sprintf(
            __(
                'Go to AI for SEO > Account, click %s, then follow the on-screen steps.',
                "ai-for-seo"
            ),
...
echo "<div class='ai4seo-display-none ai4seo-help-content' id='ai4seo-help-troubleshooting'>";
    ...
    echo "<div class='ai4seo-form'>";
        ...
        echo "<button type='button' onclick='ai4seo_save_anything(jQuery(this), ai4seo_validate_troubleshooting_settings);' id='ai4seo-save-troubleshooting-settings' class='button ai4seo-button ai4seo-submit-button ai4seo-big-button'>" . esc_html__("Save troubleshooting settings", "ai-for-seo") . "</button>";
    echo "</div>";
