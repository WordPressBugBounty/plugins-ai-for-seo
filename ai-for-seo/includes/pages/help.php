...
echo "<div class='ai4seo-display-none ai4seo-help-content' id='ai4seo-help-faq'>";
    ...
    echo "<div class='ai4seo-faq-section-holder'>";
        ...
        ai4seo_echo_wp_kses(ai4seo_get_accordion_element('> ' . esc_html__('How do I turn off or stop SEO Autopilot automation?', 'ai-for-seo'), $ai4seo_this_accordion_content));

        /* translators: %s: plugin name */
        $ai4seo_this_accordion_content = sprintf(esc_html__('Yes. Open the "Set up SEO Autopilot" modal and change "Auto Queue Entries" to "Only process manually queued entries". SEO Autopilot can stay active, but it will only process entries that you manually add to the queue from *%s* lists, supported WordPress lists, or available queue buttons. Use this when you want to review batches first, for example during a migration, redesign, product import, or launch cleanup.', 'ai-for-seo'), esc_html(AI4SEO_PLUGIN_NAME));
        ...
        $ai4seo_this_accordion_content = __("Not by default. SEO Autopilot keeps existing SEO titles, meta descriptions, focus keyphrases, meta tags, and media attributes unless you enable the related 'Overwrite Existing Metadata (SEO Autopilot Only)' or media overwrite options in the settings.", 'ai-for-seo');
        ...
        $ai4seo_this_accordion_content = sprintf(
            /* translators: %s: plugin name */
            esc_html__('Use "Mark as not generated" when you want *%s* to forget that selected entries were already generated, while keeping saved metadata, synced third-party SEO plugin values, and saved media fields unchanged. Use "Delete plugin metadata" only when you want to remove active plugin metadata saved for selected posts, pages, or products. This does not delete third-party SEO plugin data or media library fields, so review synced data separately if needed.', 'ai-for-seo'),
            esc_html(AI4SEO_PLUGIN_NAME)
        );
        ai4seo_echo_wp_kses(ai4seo_get_accordion_element('> ' . esc_html__('After generating with the wrong settings, should I mark entries as not generated or delete plugin metadata?', 'ai-for-seo'), $ai4seo_this_accordion_content));
    ...
    echo "<div class='ai4seo-faq-section-holder'>";
        ...
        $ai4seo_this_accordion_content .= __('1. Reset Cache - this clears stored data and forces the plugin to create fresh temporary cache data.', 'ai-for-seo') . '<br />';
        ...
        ai4seo_echo_wp_kses(ai4seo_get_accordion_element('> ' . esc_html__('Why do I see old data while generating metadata or media attributes?', 'ai-for-seo'), $ai4seo_this_accordion_content));
