...
echo "<div class='ai4seo-display-none ai4seo-help-content' id='ai4seo-help-faq'>";
    ...
    echo "<div class='ai4seo-faq-section-holder'>";
        ...
        $ai4seo_this_accordion_content .= sprintf(
            ...
            "- " . __('The Pro subscription grants you %1$u Credits per month, designed for professionals who need more extensive SEO capabilities. It covers approximately %2$u focus keyphrases, meta tags, or image attributes per month, depending on your selected settings.', "ai-for-seo") . "<br />",
            esc_html($ai4seo_m_plan_credits),
            esc_html($ai4seo_m_plan_credits),
        );
        $ai4seo_this_accordion_content .= sprintf(
        ...
        $ai4seo_this_accordion_content .= sprintf(
            ...
            "- " . __("The Pro subscription is designed for professionals who need more extensive SEO capabilities. It covers approximately %u focus keyphrases, meta tags, or image attributes per month, depending on your selected settings.", "ai-for-seo") . "<br />",
            esc_html($ai4seo_m_plan_credits),
        );
        $ai4seo_this_accordion_content .= sprintf(
            ...
            echo "<div class='ai4seo-form-item'>";
                ...
                echo "<div class='ai4seo-form-item-input-wrapper'>";
                    ...
                    if ($ai4seo_generated_data_reset_post_type_counts) {
                        ...
                        ai4seo_echo_wp_kses(ai4seo_get_generated_data_reset_post_type_checkboxes_html(
