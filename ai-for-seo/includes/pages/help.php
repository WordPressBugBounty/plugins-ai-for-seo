...
echo "<div class='ai4seo-help-selection-container'>";
    ...
    // Getting started
    echo "<a href='#ai4seo-getting-started-section'><div class='ai4seo-help-preview-selection ai4seo-help-navigation-link' data-ai4seo-help-target='ai4seo-help-getting-started'>";
        ai4seo_echo_wp_kses(ai4seo_get_svg_tag("rocket"));
        echo "<span>" . esc_html__("Getting started", "ai-for-seo") . "</span>";
    echo "</div></a>";

    // FAQ
    echo "<a href='#ai4seo-faq-section'><div class='ai4seo-help-preview-selection ai4seo-help-navigation-link' data-ai4seo-help-target='ai4seo-help-faq'>";
    ...
    // Troubleshooting
    echo "<a href='#ai4seo-troubleshooting-section'><div class='ai4seo-help-preview-selection ai4seo-help-navigation-link' data-ai4seo-help-target='ai4seo-help-troubleshooting'>";
        echo "<i class='dashicons dashicons-hammer'></i>";
        echo "<span>" . esc_html__("Troubleshooting", "ai-for-seo") . "</span>";
    echo "</div></a>";

    // Useful links
    echo "<a href='#ai4seo-links-section'><div class='ai4seo-help-preview-selection ai4seo-help-navigation-link' data-ai4seo-help-target='ai4seo-help-links'>";
...
echo "<div class='ai4seo-display-none ai4seo-help-content' id='ai4seo-help-getting-started'>";
    ...
    /* translators: %s: plugin name */
    $ai4seo_this_accordion_content .= "<p><b>6.1.</b> " . sprintf(esc_html__("<b>Settings -> Metadata</b>: In this section you can change the settings for the metadata generated by the *%s* plugin. This will affect content types such as pages, posts and products.", "ai-for-seo"), esc_html(AI4SEO_PLUGIN_NAME)) . "</p>";

    /* translators: %s: plugin name */
    $ai4seo_this_accordion_content .= "<p><b>6.2.</b> " . sprintf(esc_html__("<b>Settings -> Media attributes</b>: In this section you can change the settings for the media attributes generated by the *%s* plugin. This will affect media files.", "ai-for-seo"), esc_html(AI4SEO_PLUGIN_NAME)) . "</p>";

    /* translators: %s: plugin name */
    $ai4seo_this_accordion_content .= "<p><b>6.3.</b> " . sprintf(esc_html__("<b>Settings -> User Management</b>: Here you can select the user groups that should be able to manage the *%s* plugin.", "ai-for-seo"), esc_html(AI4SEO_PLUGIN_NAME)) . "</p>";
    ...
    $ai4seo_this_accordion_content .= "<p><b>3.</b> " . esc_html__("Edit existing SEO content or generate new content using our \"Generate with SOOZ\" buttons.", "ai-for-seo") . "</p>";
    ...
    /* translators: %s: plugin name */
    $ai4seo_this_accordion_content .= "<p>" . sprintf(esc_html__("<b>Alternatively,</b> you can go to the \"Pages\" or \"Posts\" page within the *%s* plugin. From there, you can browse through your pages and posts, and choose the ones you want to edit.", "ai-for-seo"), esc_html(AI4SEO_PLUGIN_NAME)) . "</p>";
    ...
    /* translators: %s: plugin name */
    $ai4seo_this_accordion_content .= sprintf(esc_html__("Once the media-modal is opened you will see the *%s*-generate-buttons on the right side above and within the form. Then click on the button to generate the content for each attribute.", "ai-for-seo"), esc_html(AI4SEO_PLUGIN_NAME)) . "</p>";
    ...
    /* translators: %s: plugin name */
    $ai4seo_this_accordion_content .= sprintf(esc_html__("Once the edit-media-page is opened you will see the *%s*-generate-buttons within the form of the page. Then click on the button to generate the content for each attribute.", "ai-for-seo"), esc_html(AI4SEO_PLUGIN_NAME)) . "</p>";
    /* translators: %s: plugin name */
    $ai4seo_this_accordion_content .= "<p>" . sprintf(esc_html__("<b>Alternatively,</b> you can go to the \"Media\" page within the *%s* plugin. From there, you can browse through your media-entries, and choose the ones you want to edit.", "ai-for-seo"), esc_html(AI4SEO_PLUGIN_NAME)) . "</p>";
    ...
    foreach ($ai4seo_credits_packs AS $ai4seo_this_payg_stripe_price_id => $ai4seo_credits_pack_entry) {
        if (isset($ai4seo_credits_pack_entry["credits_amount"])) {
            $ai4seo_available_credits_packs[] = number_format($ai4seo_credits_pack_entry["credits_amount"]);
        }
    }
    ...
    $ai4seo_this_accordion_content .= "<p>" . sprintf(
        /* translators: %1$u: number of credits, %2$u: number of daily free credits, %3$u: number of credits */
        __('The <b>free plan</b> provides you with %1$u Credits, allowing you to experiment with AI-generated SEO content without any cost. In addition, we provide you with %2$u free Credits every day if your balance falls below %3$u Credits.', "ai-for-seo"),
        esc_html($ai4seo_free_plan_credits),
        esc_html(AI4SEO_DAILY_FREE_CREDITS_AMOUNT),
        esc_html($ai4seo_free_plan_credits),
    ) . "</p>";
    $ai4seo_this_accordion_content .= "<p>" . sprintf(
        /* translators: %u: number of credits */
    ...
    if (ai4seo_is_plugin_or_theme_active(AI4SEO_THIRD_PARTY_PLUGIN_YOAST_SEO)) {
        ...
        $ai4seo_this_accordion_content .= "<p><b>2.</b> " . esc_html__("Click on the \"Generate with SOOZ\" button, which you'll find within the SEO-form.", "ai-for-seo") . "</p>";
...
echo "<div class='ai4seo-display-none ai4seo-help-content' id='ai4seo-help-faq'>";
    ...
    echo "<div class='ai4seo-faq-section-holder'>";
        ...
        /* translators: %1$s plugin name, %2$s plugin name */
            esc_html__('*%1$s* is compatible with all major SEO plugins. The metadata generated by *%2$s* can be synchronized with popular plugins such as Yoast SEO, Rank Math, SEOPress, All in One SEO, Slim SEO, SEO Simple Pack, Squirrly SEO, The SEO Framework, and Blog2Social. This ensures your metadata remains up-to-date and seamlessly integrates with your preferred SEO tool.', 'ai-for-seo'),
            esc_html(AI4SEO_PLUGIN_NAME),
            esc_html(AI4SEO_PLUGIN_NAME)
        );
        /* translators: %s: plugin name */
        ai4seo_echo_wp_kses(ai4seo_get_accordion_element("> " . sprintf(esc_html__("Can I use *%s* alongside another SEO plugin?", "ai-for-seo"), esc_html(AI4SEO_PLUGIN_NAME)), $ai4seo_this_accordion_content));
        /* translators: %s: plugin name */
        $ai4seo_this_accordion_content = sprintf(esc_html__("To enable synchronization with another SEO plugin:<br><br>1. Navigate to the plugin settings and go to the 'Sync *%s* Changes': section.<br>2. Check the box next to your desired SEO plugin to activate syncing.<br><br>If you're using the SEO Autopilot (Bulk Generation) feature, make sure the relevant meta tags are enabled in the 'Overwrite Existing Metadata (SEO Autopilot Only)': section to replace outdated data within your existing SEO plugin.", "ai-for-seo"), esc_html(AI4SEO_PLUGIN_NAME));

        ai4seo_echo_wp_kses(ai4seo_get_accordion_element("> " . esc_html__("How do I activate the synchronization with another SEO plugin?", "ai-for-seo"), $ai4seo_this_accordion_content));

        $ai4seo_this_accordion_content = sprintf(
            /* translators: %1$s plugin name, %2$s plugin name */
            __('Changes made later in a third-party SEO plugin are not visible because *%1$s* handles the frontend output of your meta tags.<br><br>You have two options:<br>1. Apply your updates in the *%2$s* metadata editor and let them sync to your third-party SEO plugin.<br>2. Go to Settings > Show Advanced Settings > Meta Tag Output Mode and set it to "Complementary".', "ai-for-seo"),
            esc_html(AI4SEO_PLUGIN_NAME),
            esc_html(AI4SEO_PLUGIN_NAME)
        );
        ai4seo_echo_wp_kses(ai4seo_get_accordion_element("> " . esc_html__("Changes in third-party SEO plugins are not applied. What can I do?", "ai-for-seo"), $ai4seo_this_accordion_content));
        ...
        ai4seo_echo_wp_kses(ai4seo_get_accordion_element("> " . esc_html__("What are the benefits of providing SEO metadata for my website?", "ai-for-seo"), $ai4seo_this_accordion_content));
        ...
        ai4seo_echo_wp_kses(ai4seo_get_accordion_element("> " . esc_html__("How can I include WooCommerce product prices in generated metadata?", "ai-for-seo"), $ai4seo_this_accordion_content));
        ...
        ai4seo_echo_wp_kses(ai4seo_get_accordion_element("> " . esc_html__("Is AI-generated SEO-content harmful to my SEO-ranking?", "ai-for-seo"), $ai4seo_this_accordion_content));

        /* translators: %s: plugin name */
        $ai4seo_this_accordion_content = sprintf(esc_html__("Yes, you can use your existing subscription and Credits Packs on another website. Simply enter the same license holder and the license key on the new website under %s > Account. You can link any number of websites together. All linked websites share the same pool of Credits and various settings. You can even export and import settings between websites using the 'Export/Import Settings' button in the plugin settings.", "ai-for-seo"), esc_html(AI4SEO_PLUGIN_NAME));
        ai4seo_echo_wp_kses(ai4seo_get_accordion_element("> " . esc_html__("Can I use my already purchased subscription or Credits Packs on another website?", "ai-for-seo"), $ai4seo_this_accordion_content));
        ...
        ai4seo_echo_wp_kses(ai4seo_get_accordion_element("> " . esc_html__("Can you add feature x, y or z to the plugin?", "ai-for-seo"), $ai4seo_this_accordion_content));
        ...
        ai4seo_echo_wp_kses(ai4seo_get_accordion_element("> " . esc_html__("Will the AI tool automatically analyze my content?", "ai-for-seo"), $ai4seo_this_accordion_content));
        ...
        /* translators: %s: plugin name */
        ai4seo_echo_wp_kses(ai4seo_get_accordion_element("> " . sprintf(esc_html__("Does *%s* support multi-language websites?", "ai-for-seo"), esc_html(AI4SEO_PLUGIN_NAME)), $ai4seo_this_accordion_content));
        ...
        ai4seo_echo_wp_kses(ai4seo_get_accordion_element("> " . esc_html__("What is the recommended cron job setting for WordPress?", "ai-for-seo"), $ai4seo_this_accordion_content));
        ...
        ai4seo_echo_wp_kses(ai4seo_get_accordion_element("> " . esc_html__("I use WordPress’s internal cron system (WP-Cron). What should I consider?", "ai-for-seo"), $ai4seo_this_accordion_content));
        ...
        ai4seo_echo_wp_kses(ai4seo_get_accordion_element("> " . esc_html__("I use an external cron job system, but I can only run the cron job every 2+ minutes or less frequently. What should I do?", "ai-for-seo"), $ai4seo_this_accordion_content));
        ...
        ai4seo_echo_wp_kses(ai4seo_get_accordion_element("> " . esc_html__("The SEO Autopilot ignored some entries or marked them as already completed. What can I do?", "ai-for-seo"), $ai4seo_this_accordion_content));
        ...
        ai4seo_echo_wp_kses(ai4seo_get_accordion_element("> " . esc_html__("I see old data in the plugin while generating metadata or media attributes. What can I do?", "ai-for-seo"), $ai4seo_this_accordion_content));
        ...
        ai4seo_echo_wp_kses(ai4seo_get_accordion_element("> " . esc_html__("How can I reset the plugin settings to their default values?", "ai-for-seo"), $ai4seo_this_accordion_content));
        ...
        ai4seo_echo_wp_kses(ai4seo_get_accordion_element("> " . esc_html__("I want to uninstall the plugin and remove all generated data. How can I do this?", "ai-for-seo"), $ai4seo_this_accordion_content));

        $ai4seo_this_accordion_content = sprintf(
            /* translators: %1$s plugin name, %2$s plugin name, %3$s plugin name */
            esc_html__('It depends on how the metadata is stored and used. If *%1$s* has synchronized the generated metadata with a third-party SEO plugin like Yoast SEO, Rank Math, SEOPress, or similar, then the metadata will remain even after uninstalling *%2$s*. You can check and enable synchronization in your *%3$s* settings.', 'ai-for-seo'),
            esc_html(AI4SEO_PLUGIN_NAME),
            esc_html(AI4SEO_PLUGIN_NAME),
            esc_html(AI4SEO_PLUGIN_NAME)
        ) . "<br /><br />";
        ...
        /* translators: %s: plugin name */
        $ai4seo_this_accordion_content .= sprintf(esc_html__("However, if synchronization was not enabled, and *%s* was solely responsible for outputting meta tags on your site, then those tags will no longer be generated once the plugin is deactivated or uninstalled.", "ai-for-seo"), esc_html(AI4SEO_PLUGIN_NAME));
        ai4seo_echo_wp_kses(ai4seo_get_accordion_element("> " . esc_html__("Will all the generated texts disappear if I uninstall the plugin?", "ai-for-seo"), $ai4seo_this_accordion_content));
        ...
        ai4seo_echo_wp_kses(ai4seo_get_accordion_element("> " . esc_html__("I used the wrong settings for manual or bulk generation (e.g., wrong language or missing sync with other SEO plugins). What can I do?", "ai-for-seo"), $ai4seo_this_accordion_content));
        ...
        ai4seo_echo_wp_kses(ai4seo_get_accordion_element("> " . esc_html__("I use the NextGen Gallery plugin — how do I generate media attributes for my images?", "ai-for-seo"), $ai4seo_this_accordion_content));
        ...
        /* translators: %s: plugin name */
        $ai4seo_this_accordion_content  = sprintf(esc_html__("Yes, you can use *%s* on staging or local development sites.", "ai-for-seo"), esc_html(AI4SEO_PLUGIN_NAME));
        ai4seo_echo_wp_kses(
            ai4seo_get_accordion_element(
                /* translators: %s: plugin name */
                '> ' . sprintf(esc_html__("Can I use *%s* on a staging or local development site?", "ai-for-seo"), esc_html(AI4SEO_PLUGIN_NAME)),
                $ai4seo_this_accordion_content
            )
        );
        ...
        $ai4seo_this_accordion_content = __("If generated metadata does not appear on the frontend, try the following steps:", "ai-for-seo") . "<br /><br />";
        ...
        $ai4seo_this_accordion_content .= __("2. If you do not use a caching plugin or the issue persists, please contact our support team for further assistance.", "ai-for-seo");
        ai4seo_echo_wp_kses(ai4seo_get_accordion_element("> " . esc_html__("Generated metadata is not visible on the frontend. What can I do?", "ai-for-seo"), $ai4seo_this_accordion_content));
    ...
    echo "<div class='ai4seo-faq-section-holder'>";
        ...
        /* translators: %s: plugin name */
        $ai4seo_this_accordion_content = sprintf(esc_html__("You can automate the generation of metadata by selecting the desired content type within the 'Set up SEO Autopilot' modal. This modal can be accessed by clicking the 'Set up SEO Autopilot'-button within the 'SEO Autopilot (Bulk Generation)'-section on the *%s* dashboard of your WordPress website.", "ai-for-seo"), esc_html(AI4SEO_PLUGIN_NAME));
        ai4seo_echo_wp_kses(ai4seo_get_accordion_element("> " . esc_html__("How can I automate the process of generating metadata for my website?", "ai-for-seo"), $ai4seo_this_accordion_content));

        /* translators: %s: plugin name */
        $ai4seo_this_accordion_content = sprintf(esc_html__("You can automate the generation of alt text, titles, captions, and descriptions for images by selecting 'Media files' within the 'Set up SEO Autopilot' modal. This modal can be accessed by clicking the 'Set up SEO Autopilot'-button within the 'SEO Autopilot (Bulk Generation)'-section on the *%s* dashboard of your WordPress website.", "ai-for-seo"), esc_html(AI4SEO_PLUGIN_NAME));
        ai4seo_echo_wp_kses(ai4seo_get_accordion_element("> " . esc_html__("How can I automate the process of generating alt text, titles, captions, and descriptions for images on my website?", "ai-for-seo"), $ai4seo_this_accordion_content));
        ...
        ai4seo_echo_wp_kses(ai4seo_get_accordion_element("> " . esc_html__("Can I turn off the automation feature after I've activated it?", "ai-for-seo"), $ai4seo_this_accordion_content));

        /* translators: %s: plugin name */
        $ai4seo_this_accordion_content = sprintf(esc_html__("Yes! You can decide exactly how the SEO Autopilot behaves. By default, the plugin automatically generates metadata and media attributes for both new and existing content. However, you can customize this behavior using three options:<br>• New and existing entries<br>• New entries only<br>• Existing entries only<br><br>You can change these settings anytime in the <strong>Set up SEO Autopilot</strong> modal. Just click the <strong>Set up SEO Autopilot</strong> button in the <strong>SEO Autopilot (Bulk Generation)</strong> section of your *%s* dashboard.", "ai-for-seo"), esc_html(AI4SEO_PLUGIN_NAME));
        ai4seo_echo_wp_kses(ai4seo_get_accordion_element("> " . esc_html__("Does the SEO Autopilot (bulk generation) feature work for new content?", "ai-for-seo"), $ai4seo_this_accordion_content));
        ...
        ai4seo_echo_wp_kses(ai4seo_get_accordion_element("> " . esc_html__("Will the SEO Autopilot (bulk generation) feature affect existing data (meta-title, meta-description, etc.)?", "ai-for-seo"), $ai4seo_this_accordion_content));

        $ai4seo_this_accordion_content = __("Yes, in the 'Active Meta Tags'-section of the settings, you can choose to include or exclude specific meta tags from the header output generated by our plugin. This gives you full control to customize the meta tags based on your specific requirements.", "ai-for-seo");
        ai4seo_echo_wp_kses(ai4seo_get_accordion_element("> " . esc_html__("Is there any way to control what meta tags are outputted?", "ai-for-seo"), $ai4seo_this_accordion_content));

        /* translators: %s: plugin name */
        $ai4seo_this_accordion_content = sprintf(esc_html__("Yes, *%s* lets you decide which media attributes (like 'alt text' or 'title') should be generated. You can configure this in the 'Active Media Attributes:' section of the settings to match your content needs. Simply select the desired attributes and the SEO Autopilot will generate the data accordingly.", "ai-for-seo"), esc_html(AI4SEO_PLUGIN_NAME));
        ai4seo_echo_wp_kses(ai4seo_get_accordion_element("> " . esc_html__("Can I choose which media attributes the plugin should generate?", "ai-for-seo"), $ai4seo_this_accordion_content));

        /* translators: %s: plugin name */
        $ai4seo_this_accordion_content = sprintf(esc_html__("You can find the 'Retry all failed' button in any content pages (e.g. Pages, Posts or media) and on your %s dashboard. This allows you to retry all failed metadata generations with a single click, saving you time and effort. Please note that this button will only be displayed if at least one error has occurred.", "ai-for-seo"), esc_html(AI4SEO_PLUGIN_NAME));
        ai4seo_echo_wp_kses(ai4seo_get_accordion_element("> " . esc_html__("How can I retry all failed metadata generations with just one click?", "ai-for-seo"), $ai4seo_this_accordion_content));
        ...
        ai4seo_echo_wp_kses(ai4seo_get_accordion_element("> " . esc_html__("Why is the automatic metadata or media attributes generation pending?", "ai-for-seo"), $ai4seo_this_accordion_content));
    ...
    echo "<div class='ai4seo-faq-section-holder'>";
        ...
        ai4seo_echo_wp_kses(ai4seo_get_accordion_element("> " . esc_html__("How do I navigate to the page I want to edit for SEO?", "ai-for-seo"), $ai4seo_this_accordion_content));

        /* translators: %s: plugin name */
        $ai4seo_this_accordion_content = sprintf(esc_html__("You can find the *%s* button in the top admin-bar. Clicking on this will open up the metadata editor where you can modify or generate metadata.", "ai-for-seo"), esc_html(AI4SEO_PLUGIN_NAME));
        /* translators: %s: plugin name */
        ai4seo_echo_wp_kses(ai4seo_get_accordion_element("> " . sprintf(esc_html__("Where is the *%s* metadata editor located?", "ai-for-seo"), esc_html(AI4SEO_PLUGIN_NAME)), $ai4seo_this_accordion_content));

        /* translators: %s: plugin name */
        $ai4seo_this_accordion_content = sprintf(esc_html__("After opening the *%s* metadata editor, you can either edit the existing metadata manually or generate new metadata using the 'Generate with SOOZ' buttons.", "ai-for-seo"), esc_html(AI4SEO_PLUGIN_NAME));
        ai4seo_echo_wp_kses(ai4seo_get_accordion_element("> " . esc_html__("How can I generate or edit metadata?", "ai-for-seo"), $ai4seo_this_accordion_content));

        /* translators: %s: plugin name */
        $ai4seo_this_accordion_content = sprintf(esc_html__("Yes, alternatively, you can go to the 'Pages' or 'Posts' page within the *%s* plugin. From there, you can browse through your pages and posts, and choose the ones you want to edit.", "ai-for-seo"), esc_html(AI4SEO_PLUGIN_NAME));
        /* translators: %s: plugin name */
        ai4seo_echo_wp_kses(ai4seo_get_accordion_element("> " . sprintf(esc_html__("Is there an alternate way to access *%s*'s Metadata Editor?", "ai-for-seo"), esc_html(AI4SEO_PLUGIN_NAME)), $ai4seo_this_accordion_content));
        ...
        /* translators: %s: plugin name */
        ai4seo_echo_wp_kses(ai4seo_get_accordion_element("> " . sprintf(esc_html__("How do I edit metadata in Elementor with *%s*?", "ai-for-seo"), esc_html(AI4SEO_PLUGIN_NAME)), $ai4seo_this_accordion_content));
        ...
        /* translators: %s: plugin name */
        ai4seo_echo_wp_kses(ai4seo_get_accordion_element("> " . sprintf(esc_html__("How do I edit SEO settings in BeBuilder with *%s*?", "ai-for-seo"), esc_html(AI4SEO_PLUGIN_NAME)), $ai4seo_this_accordion_content));
        ...
        ai4seo_echo_wp_kses(ai4seo_get_accordion_element("> " . esc_html__("I cannot access the plugin due to incognito mode restriction. What can I do?", "ai-for-seo"), $ai4seo_this_accordion_content));
    echo "</div>";
    ...
    echo "<div class='ai4seo-faq-section-holder'>";
        ...
        $ai4seo_this_accordion_content = sprintf(
            /* translators: %1$u: daily free credits, %2$u: free plan credits */
            __('The free plan renews on a daily basis. You will receive %1$u free Credits every day if your balance falls below %2$u Credits, allowing you to continue using the basic features of the plugin at no cost.', "ai-for-seo"),
            esc_html(AI4SEO_DAILY_FREE_CREDITS_AMOUNT),
            esc_html($ai4seo_free_plan_credits),
        );
        ai4seo_echo_wp_kses(ai4seo_get_accordion_element("> " . esc_html__("Are Credits renewed in the Free plan?", "ai-for-seo"), $ai4seo_this_accordion_content));
        ...
        ai4seo_echo_wp_kses(ai4seo_get_accordion_element("> " . esc_html__("What do I need to do to receive the free daily Credits?", "ai-for-seo"), $ai4seo_this_accordion_content));
        ...
        ai4seo_echo_wp_kses(ai4seo_get_accordion_element("> " . esc_html__("Will I still receive the free daily Credits if I'm on a paid subscription?", "ai-for-seo"), $ai4seo_this_accordion_content));

        /* translators: %s: plugin name */
        $ai4seo_this_accordion_content = sprintf(esc_html__("Credits are used when *%s* generates metadata for your content (posts, pages, products, media files etc.). The amount of Credits required depends on the selected active meta tags and media attributes (see Settings).", "ai-for-seo"), esc_html(AI4SEO_PLUGIN_NAME)) . "<br /><br />";
        /* translators: %s: plugin name */
        ai4seo_echo_wp_kses(ai4seo_get_accordion_element("> " . sprintf(esc_html__("How are Credits consumed in the *%s* plugin?", "ai-for-seo"), esc_html(AI4SEO_PLUGIN_NAME)), $ai4seo_this_accordion_content));

        $ai4seo_this_accordion_content = sprintf(
            /* translators: %1$u: free plan credits, %2$u: daily free credits, %3$u: free plan credits */
            __('Yes, the free plan provides you with %1$u Credits, allowing you to experiment with AI-generated SEO content without any cost. In addition, we provide you with %2$u free Credits every day if your balance falls below %3$u Credits. However it does not include advanced features available in paid subscriptions.', "ai-for-seo"),
            esc_html($ai4seo_free_plan_credits),
            esc_html(AI4SEO_DAILY_FREE_CREDITS_AMOUNT),
            esc_html($ai4seo_free_plan_credits),
        );
        /* translators: %s: plugin name */
        ai4seo_echo_wp_kses(ai4seo_get_accordion_element("> " . sprintf(esc_html__("Can I try the *%s* plugin without purchasing a subscription?", "ai-for-seo"), esc_html(AI4SEO_PLUGIN_NAME)), $ai4seo_this_accordion_content));

        $ai4seo_this_accordion_content = sprintf(
            /* translators: %1$u: s plan credits, %2$u: s plan credits */
            "- " . __('The Basic subscription grants you %1$u Credits per month, suitable for smaller websites or blogs. It covers approximately %2$u focus keyphrases, meta tags, or image attributes per month, depending on your selected settings. Existing data can be used as reference for new data generations.', "ai-for-seo") . "<br />",
            esc_html($ai4seo_s_plan_credits),
            esc_html($ai4seo_s_plan_credits),
        );
        $ai4seo_this_accordion_content .= sprintf(
            /* translators: %1$u: m plan credits, %2$u: m plan credits */
            "- " . __('The Pro subscription grants you %1$u Credits per month, designed for professionals who need more extensive SEO capabilities. It covers approximately %2$u focus keyphrases, meta tags, or image attributes per month, depending on your selected settings. It also features improved entity recognition in images.', "ai-for-seo") . "<br />",
            esc_html($ai4seo_m_plan_credits),
            esc_html($ai4seo_m_plan_credits),
        );
        $ai4seo_this_accordion_content .= sprintf(
            /* translators: %1$u: l plan credits, %2$u: l plan credits */
            "- " . __('The Premium subscription grants you %1$u Credits per month, ideal for businesses that require substantial SEO support and features. It covers approximately %2$u focus keyphrases, meta tags, or image attributes per month, depending on your selected settings. It also features improved entity and celebrity face recognition in images.', "ai-for-seo"),
            esc_html($ai4seo_l_plan_credits),
            esc_html($ai4seo_l_plan_credits),
        );
        ai4seo_echo_wp_kses(ai4seo_get_accordion_element("> " . esc_html__("How many Credits do I get with the Basic, Pro, and Premium subscriptions?", "ai-for-seo"), $ai4seo_this_accordion_content));
        ...
        $ai4seo_this_accordion_content .= sprintf(
            /* translators: %u: free plan credits */
            "- " . __("The free plan is great for experimentation. It covers approximately %u focus keyphrases, meta tags, or image attributes per month, depending on your selected settings. However it does not include advanced features available in paid subscriptions.", "ai-for-seo") . "<br />",
            esc_html($ai4seo_free_plan_credits),
        );
        $ai4seo_this_accordion_content .= sprintf(
            /* translators: %u: s plan credits */
            "- " . __("The Basic subscription is suitable for smaller websites or blogs. It covers approximately %u focus keyphrases, meta tags, or image attributes per month, depending on your selected settings. Existing data can be used as reference for new data generations.", "ai-for-seo") . "<br />",
            esc_html($ai4seo_s_plan_credits),
        );
        $ai4seo_this_accordion_content .= sprintf(
            /* translators: %u: m plan credits */
            "- " . __("The Pro subscription is designed for professionals who need more extensive SEO capabilities. It covers approximately %u focus keyphrases, meta tags, or image attributes per month, depending on your selected settings. It also features improved entity recognition in images.", "ai-for-seo") . "<br />",
            esc_html($ai4seo_m_plan_credits),
        );
        $ai4seo_this_accordion_content .= sprintf(
            /* translators: %u: l plan credits */
        ...
        ai4seo_echo_wp_kses(ai4seo_get_accordion_element("> " . esc_html__("How do I choose the right subscription for my needs?", "ai-for-seo"), $ai4seo_this_accordion_content));
        ...
        ai4seo_echo_wp_kses(ai4seo_get_accordion_element(
        ...
        ai4seo_echo_wp_kses(
            ai4seo_get_accordion_element(
                '> ' . esc_html__( 'Where can I download my invoice?', 'ai-for-seo' ),
                $ai4seo_this_accordion_content
            )
        );
        ...
        ai4seo_echo_wp_kses(ai4seo_get_accordion_element("> " . esc_html__("How do I change or cancel my subscription?", "ai-for-seo"), $ai4seo_this_accordion_content));
        ...
        ai4seo_echo_wp_kses(ai4seo_get_accordion_element("> " . esc_html__("Can I upgrade or downgrade my subscription?", "ai-for-seo"), $ai4seo_this_accordion_content));
        ...
        ai4seo_echo_wp_kses(ai4seo_get_accordion_element("> " . esc_html__("Do unused Credits expire at the end of the month?", "ai-for-seo"), $ai4seo_this_accordion_content));
    echo "</div>";
echo "</div>";
...
echo "<div class='ai4seo-display-none ai4seo-help-content' id='ai4seo-help-troubleshooting'>";
    ...
    echo "<div class='ai4seo-form ai4seo-unsaved-changes-warnings'>";
        echo "<div class='card ai4seo-form-section ai4seo-troubleshooting-settings-card'>";
            ...
            echo "<h2>";
                ...
                echo esc_html__("Debugging tools", "ai-for-seo");
            echo "</h2>";
        ...
        ai4seo_echo_wp_kses(ai4seo_get_submit_button_tag(esc_html__("Save troubleshooting settings", "ai-for-seo"), "ai4seo-start-inactive ai4seo-lockable", "ai4seo_save_anything(jQuery(this), ai4seo_validate_troubleshooting_settings);"));
    echo "</div>";
    ...
    echo "<div class='card ai4seo-form-section ai4seo-troubleshooting-settings-card'>";
        ...
        echo "<div id='ai4seo-debug-message-log-entries' style='max-height: 240px; overflow: auto; padding: 0 1.5rem 1rem 1.5rem; max-width: 100%; white-space: pre-wrap;'>";
            if (empty($ai4seo_debug_message_entries)) {
                    echo "<p style='margin: 0;'>" . esc_html__("No debug messages recorded yet. Entries stored with \"Store in the database\" will appear here.", "ai-for-seo") . "</p>";
            } else {
    ...
    echo "<div class='ai4seo-buttons-wrapper ai4seo-help-debug-log-buttons'>";
        if (!empty($ai4seo_debug_message_entries)) {
            ...
            echo "<button type='button' class='ai4seo-button ai4seo-copy-to-clipboard ai4seo-debug-log-copy-button' data-clipboard-text='" . esc_attr(implode("\n", $ai4seo_debug_messages_container_for_clipboard)) . "' title='" . esc_attr__("Copy debug log to clipboard", "ai-for-seo") . "'>";
                ...
                echo " <span style='float: right' class='ai4seo-debug-log-copy-to-clipboard-tooltip ai4seo-copied-to-clipboard' style='display: none'>👍 " . esc_html__("Copied!", "ai-for-seo") . "</span>";
            echo "</button>";
    ...
    echo "<div class='ai4seo-faq-section-holder'>";
        ...
        ai4seo_echo_wp_kses(ai4seo_get_accordion_element("> " . esc_html__("WP-Cron is not running reliably on my website. How do I switch to an external cron job?", "ai-for-seo"), $ai4seo_this_accordion_content));
