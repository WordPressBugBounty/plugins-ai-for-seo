...
echo "<div class='ai4seo-help-selection-container'>";
	...
	echo "<a href='" . esc_url( $ai4seo_help_sections['getting-started']['url'] ) . "'" . ( $ai4seo_help_sections['getting-started']['is_active'] ? " aria-current='page'" : '' ) . "><div class='" . esc_attr( $ai4seo_help_sections['getting-started']['navigation_class'] ) . "' data-ai4seo-help-target='" . esc_attr( $ai4seo_help_sections['getting-started']['target_id'] ) . "'>";
		ai4seo_echo_wp_kses( ai4seo_get_svg_tag( 'rocket' ) );
...
echo "<div class='" . esc_attr( $ai4seo_help_sections['getting-started']['content_class'] ) . "' id='" . esc_attr( $ai4seo_help_sections['getting-started']['target_id'] ) . "'>";
	...
	$ai4seo_this_accordion_content .= '<p><b>8.</b> ' . __( '<b>Metadata editor</b>: After clicking on the button to open the metadata editor you will find the "Generate & Overwrite" button at the top of the editor. Click this button to generate all metadata for the selected content-entry. Additionally you will find the "Generate with SOOZ"-button underneath every input field which allows you to generate the metadata for a single metadata input field. After the new data has been generated you can either save the changes as generated or you can edit them if you would like to apply any changes and save afterwards.', 'ai-for-seo' ) . '</p>';
	...
	$ai4seo_this_accordion_content .= '<p><b>10.</b> ' . __( '<b>Media attribute editor</b>: After clicking on the button to open the media attribute editor you will find the "Generate & Overwrite" button at the top of the editor. Click this button to generate all media attributes for the selected media entry. Additionally you will find the "Generate with SOOZ"-button underneath every input field which allows you to generate the media attributes for a single attributes input field. After the new data has been generated you can either save the changes as generated or you can edit them if you would like to apply any changes and save afterwards.', 'ai-for-seo' ) . '</p>';
...
foreach ( $ai4seo_credits_packs as $ai4seo_this_payg_stripe_price_id => $ai4seo_credits_pack_entry ) {
	...
	echo "<div class='ai4seo-faq-section-holder'>";
		...
		$ai4seo_this_accordion_content = sprintf(
		/* translators: %1$s plugin name, %2$s plugin name */
			esc_html__( '*%1$s* is compatible with major SEO plugins. Metadata generated by *%2$s* can be synchronized with Yoast SEO, Rank Math, SEOPress, All in One SEO, Slim SEO, SEO Simple Pack, Squirrly SEO, The SEO Framework, and Blog2Social, so your SEO title, meta description, and other fields can stay aligned with your preferred SEO tool.', 'ai-for-seo' ),
			esc_html( AI4SEO_PLUGIN_NAME ),
			esc_html( AI4SEO_PLUGIN_NAME )
		);
		/* translators: %s: plugin name */
		...
		/* translators: %s: plugin name */
		$ai4seo_this_accordion_content = sprintf( __( "To enable synchronization with another SEO plugin:<br><br>1. Navigate to the plugin settings and go to the 'Sync *%s* Changes' section.<br>2. Check the box next to Yoast SEO, Rank Math, SEOPress, or your desired SEO plugin to activate syncing.<br><br>If you're using SEO Autopilot (Bulk Generation), make sure the relevant meta tags are enabled in the 'Overwrite Existing Metadata (SEO Autopilot Only)' section if you want to replace outdated data within your existing SEO plugin.", 'ai-for-seo' ), esc_html( AI4SEO_PLUGIN_NAME ) );
		...
		$ai4seo_this_accordion_content = sprintf(
			...
			esc_html__( 'It depends on how the generated data is stored and used. If *%1$s* synchronized generated metadata with a third-party SEO plugin like Yoast SEO, Rank Math, SEOPress, or similar, then that metadata remains even after uninstalling *%2$s*. Saved image attributes, such as alt text, image titles, captions, and descriptions, are WordPress media fields and may also remain in the Media Library.', 'ai-for-seo' ),
			esc_html( AI4SEO_PLUGIN_NAME ),
			esc_html( AI4SEO_PLUGIN_NAME ),
			esc_html( AI4SEO_PLUGIN_NAME )
		) . '<br /><br />';
		...
		/* translators: %s: plugin name */
		$ai4seo_this_accordion_content  = sprintf( esc_html__( 'If you cannot access *%s* because Incognito Mode is enabled or the plugin is hidden, follow these steps:', 'ai-for-seo' ), esc_html( AI4SEO_PLUGIN_NAME ) ) . '<br /><br />';
		$ai4seo_this_accordion_content .= sprintf(
			/* translators: %s: link to account settings */
		...
		/* translators: %s: plugin name */
		ai4seo_echo_wp_kses( ai4seo_get_accordion_element( '> ' . sprintf( esc_html__( 'I cannot access *%s* because Incognito Mode is enabled. What can I do?', 'ai-for-seo' ), esc_html( AI4SEO_PLUGIN_NAME ) ), $ai4seo_this_accordion_content ) );
