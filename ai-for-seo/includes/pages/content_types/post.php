...
$ai4seo_percentage_of_active_metadata_by_post_ids = ($ai4seo_orderby === 'seo_progress')
    && $ai4seo_sort_value_map
...
$ai4seo_retry_all_failed_metadata_generations_container_style = $ai4seo_should_show_retry_all_failed_metadata_generations_link ? '' : 'display: none;';
...
echo "<table class='widefat striped table-view-list pages ai4seo-posts-table'>";
    echo '<tr>';
        ...
        echo '</th>';
        echo "<th class='manage-column sortable ai4seo-content-list-sortable-column'>";
            ai4seo_echo_wp_kses(ai4seo_get_content_type_sortable_column_label_html(__('ID', 'ai-for-seo'), 'id', $ai4seo_filter_context));
        echo '</th>';
        echo "<th class='manage-column sortable ai4seo-hidden-on-mobile ai4seo-content-list-sortable-column'>";
        ...
        echo "<th class='manage-column sortable ai4seo-content-list-sortable-column'>";
            ...
            if ($ai4seo_active_meta_tags_names) {
                echo " <span style='font-size: smaller'>(" . esc_html(implode(', ', $ai4seo_active_meta_tags_names)) . ')</span>';
            }
            ...
            if ($ai4seo_should_show_retry_all_failed_metadata_generations_link || $ai4seo_should_defer_status_filters) {
                echo '<div'
                    ...
                    . " class='ai4seo-table-title-button ai4seo-content-list-retry-all-failed-button'"
                    ...
                    . ($ai4seo_retry_all_failed_metadata_generations_container_style !== '' ? ' style="' . esc_attr($ai4seo_retry_all_failed_metadata_generations_container_style) . '"' : '')
                    . '>';
    ...
    foreach ($ai4seo_all_posts as $ai4seo_this_post) {
        ...
        $ai4seo_this_post_sub_info_rows[] =
            (
                $ai4seo_this_post_is_generated
                    ...
                    : sprintf(
                        /* translators: %s: plugin name */
                        __("%s has <span style='text-decoration: underline;'>not</span> generated data for this entry yet.", 'ai-for-seo'),
                        esc_html(AI4SEO_PLUGIN_NAME)
                    )
            );
        ...
        echo '<tr>';
            ...
            echo "<td class='ai4seo-bulk-generation-queue-checkbox-column'>";
                echo "<input type='checkbox' class='ai4seo-bulk-generation-queue-entry-checkbox ai4seo-lockable' name='" . esc_attr($ai4seo_bulk_generation_queue_checkbox_name) . "[]' value='" . esc_attr($ai4seo_this_post_id) . "'>";
            echo '</td>';
            ...
            echo "<td class='ai4seo-generation-coverage'>";
                if ($ai4seo_active_meta_tags) {
                    ...
                    // output progress bar
                    echo "<div id='ai4seo-seo-coverage-progress-bar-" . esc_attr($ai4seo_this_post_id) . "' class='ai4seo-seo-coverage-progress-bar" . esc_attr($ai4seo_progress_bar_animation_class) . ($ai4seo_this_metadata_generation_is_not_finished ? ' ai4seo-progress-bar-not-finished' : ' ai4seo-progress-bar-finished') . "'>";
                    ...
                    if ($ai4seo_is_post_waiting_to_get_queued) {
                        ...
                        echo '</div>';
                    } else if ($ai4seo_should_show_autopilot_pending_note) {
                    ...
                    } else if ($ai4seo_is_post_processing) {
                        echo "<div class='ai4seo-sub-info'>";
                        ...
                        echo '</div>';
                    } else if ($ai4seo_this_post_is_fully_covered && !$ai4seo_this_post_is_generated && !$ai4seo_do_generate_metadata_for_fully_covered_entries) {
                        echo "<div class='ai4seo-sub-info ai4seo-red-message'>";
