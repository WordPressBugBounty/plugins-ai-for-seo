...
if (!$ai4seo_attachment_post_ids_filter_is_active) {
    $ai4seo_content_type_list_result = ai4seo_resolve_optimized_content_type_list(array(
...
if (!empty($ai4seo_content_type_list_result['is_optimized'])) {
    ...
    if (is_array($ai4seo_search_ids)) {
        $ai4seo_candidate_attachment_post_ids = $ai4seo_attachment_post_ids_filter_is_active
            ...
            : $ai4seo_search_ids;
    } else if (!$ai4seo_attachment_post_ids_filter_is_active || $ai4seo_attachment_post_ids_filter) {
...
if ($ai4seo_orderby === 'seo_progress') {
...
$ai4seo_retry_all_failed_attachment_attributes_container_style = $ai4seo_should_show_retry_all_failed_attachment_attributes_generations_link ? '' : 'display: none;';
        ...
        echo "<th class='manage-column sortable ai4seo-content-list-sortable-column'>";
            ...
            if (!$ai4seo_is_related_attachments_modal && ($ai4seo_should_show_retry_all_failed_attachment_attributes_generations_link || $ai4seo_should_defer_status_filters)) {
                echo '<div'
                    ...
                    . ($ai4seo_retry_all_failed_attachment_attributes_container_style !== '' ? ' style="' . esc_attr($ai4seo_retry_all_failed_attachment_attributes_container_style) . '"' : '')
                    . '>';
    ...
    foreach ($ai4seo_all_attachment_posts as $ai4seo_this_attachment) {
        ...
        echo '<tr>';
            ...
            echo "<td class='ai4seo-bulk-generation-queue-checkbox-column'>";
                echo "<input type='checkbox' class='ai4seo-bulk-generation-queue-entry-checkbox ai4seo-lockable' name='" . esc_attr($ai4seo_bulk_generation_queue_checkbox_name) . "[]' value='" . esc_attr($ai4seo_this_post_attachment_id) . "'>";
            echo '</td>';
            ...
            echo "<td class='ai4seo-generation-coverage'>";
                if ($ai4seo_active_attachment_attributes) {
                    ...
                    // output progress bar
                    echo "<div id='ai4seo-seo-coverage-progress-bar-" . esc_attr($ai4seo_this_post_attachment_id) . "' class='ai4seo-seo-coverage-progress-bar" . esc_attr($ai4seo_progress_bar_animation_class) . ($ai4seo_this_attachment_attributes_is_not_finished ? ' ai4seo-progress-bar-not-finished' : ' ai4seo-progress-bar-finished') . "'>";
                    ...
                    } else if ($ai4seo_is_attachment_post_processing) {
                        echo "<div class='ai4seo-sub-info'>";
